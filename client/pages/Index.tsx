        ...
        <div className="container mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              >
                <Card className="p-6 bg-portfolio-dark/50 border-portfolio-orange/20 hover:border-portfolio-orange/40 transition-all hover:glow-orange">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {projects.map((project, index) => (
              <motion.div
                ...
                transition={{ duration: 0.6, delay: index * 0.1 }}
              >
                <Card className="overflow-hidden bg-portfolio-dark/50 border-portfolio-orange/20 hover:border-portfolio-orange/40 transition-all hover:glow-orange group">
                  <div className="aspect-video bg-gradient-to-br from-portfolio-orange/10 to-portfolio-amber/10 relative overflow-hidden">
                    ...
                    />
                    <div className="absolute inset-0 bg-portfolio-dark/20 group-hover:bg-portfolio-dark/10 transition-colors"></div>
                  </div>
                  <div className="p-6">
            ...
            {skills.map((skill, index) => (
              ...
              >
                ...
                <div className="w-full bg-portfolio-dark/50 rounded-full h-2">
                  <motion.div 
                    className="bg-gradient-to-r from-portfolio-orange to-portfolio-amber h-2 rounded-full"
                    initial={{ width: 0 }}
